...
browser.support.chromeFrame = <?php echo (mb_strpos(mb_strtolower($_SERVER['HTTP_USER_AGENT']), " chromeframe") !== false) ? "true" : "false" ?>;
...
<?php IF (isset($this->get['opener']) && mb_strlen($this->get['opener'])): ?>
